...
def market_overall_share(
    ...
    with get_cursor() as cur:
        return queries.get_overall_market_share(cur, origination, parse_months(months), pa, top_n)
...
def market_preapproved_share(
    ...
    pa = preapproved != 'false'
    with get_cursor() as cur:
        return queries.get_preapproved_market_share(cur, origination, parse_months(months), pa, top_n)
...
def market_avg_rank(
    ...
    pa = preapproved != 'false'
    with get_cursor() as cur:
        return queries.get_avg_rank(cur, origination, parse_months(months), pa, top_n)
...
def market_avg_shelf_space(
    ...
    pa = preapproved != 'false'
    with get_cursor() as cur:
        return queries.get_avg_shelf_space(cur, origination, parse_months(months), pa, top_n)
